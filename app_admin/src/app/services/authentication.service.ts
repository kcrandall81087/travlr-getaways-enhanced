...
export class AuthenticationService {
  ...
  // Retrieve the current user. This function should only be called after the calling 
  // method has checked to make sure that the user isLoggedIn.
  ...
  // Because that method returns an observable, we subscribe to the result and only process when the Observable condition is satisfied 
  // Uncomment the two console.log messages for additional debugging information. 
  // Please Note: This method is nearly identical to the login method because the behavior of the API logs a new user in immediately upon registration
